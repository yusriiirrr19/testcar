            ...
            <div class="col-lg-10">
              <div class="row mb-5">
                <div class="col-lg-7 intro">
                  <h1><strong>Sewa Mobil</strong> Apapun dan Kapanpun!.</h1>
                </div>
              </div>
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="step">
                ...
                <div class="step-inner">
                  ...
                  <h3>Pembayaran</h3>
                  <p>
                    Dapat menggunakan metode pembayaran dalam bentuk apapun. 
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-4 ml-auto order-lg-1">
              ...
              <p class="mb-5">
                Tersedia mobil dengan merk beragam dan tahun ke tahun. Disewakan dengan harga yang bersaing. Mengutamakan kenyamanan dan keamanan pelanggan. 
              </p>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-7">
              ...
              <p class="mb-5">
                Kami akan kembali menyewa disini!. 
              </p>
            </div>
          </div>
          <div class="row">
